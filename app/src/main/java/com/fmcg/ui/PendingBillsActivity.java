	...
	protected void onCreate(@Nullable Bundle savedInstanceState)
	{
		...
		submit_tv.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				{
					Common.showDialog(PendingBillsActivity.this);
					...
					//HttpAdapter.insertFeedback(PendingBillsActivity.this, "remarks", jsonString);
					HttpAdapter.updateInvoiceSubmit(PendingBillsActivity.this, "remarks", jsonString);
