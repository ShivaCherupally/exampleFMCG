...
public class RouteDetailsData {
	...
	public RouteDetailsData(final int zoneId, final int routeId, int EmployeeRouteId,
	...
	public int getEmployeeRouteId() {
		return employeeRouteId;
	}

	public void setEmployeeRouteId(int employeeRouteIdtem) {
		employeeRouteId = employeeRouteIdtem;
	}
