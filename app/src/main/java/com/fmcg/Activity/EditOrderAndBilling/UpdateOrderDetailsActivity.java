package com.fmcg.Activity.EditOrderAndBilling;
...
public class UpdateOrderDetailsActivity extends AppCompatActivity implements NetworkOperationListener, AdapterView.OnItemSelectedListener, View.OnTouchListener
{
	...
	private Spinner order_status_spinner, product_category_spinner, payment_terms_spinner, routeName_spinner, areaName_spinner, zone_name_spinner;
...
//        ((Spinner) zone_name_spinner).getSelectedView().setEnabled(false);
//        zone_name_spinner.setEnabled(false);
		zone_name_spinner.getSelectedView();
		zone_name_spinner.setEnabled(false);
//		zone_name_spinner.setBackgroundColor(Color.BLACK);
		routeName_spinner = (Spinner) findViewById(R.id.routeName_spinner);
		routeName_spinner.setEnabled(false);
//		routeName_spinner.setBackgroundColor(Color.BLACK);
...
//			paymentNamestitle.add("Select Payment Terms Name");
	...
	private void adapterDataAssigingToSpinner(ArrayList<String> spinnerTitles, String spinnerSelction)
	{
		...
		if (spinnerSelction.equals("ZONE"))
		{
			...
			zone_name_spinner.setAdapter(zonedataAdapter);
		}
		else if (spinnerSelction.equals("ROUTE"))
		{
			ArrayAdapter<String> routeAdapter = new ArrayAdapter<String>(this, R.layout.spinneroneitem, spinnerTitles);
			routeAdapter.setDropDownViewResource(R.layout.list_item);
			routeName_spinner.setAdapter(routeAdapter);
		}
